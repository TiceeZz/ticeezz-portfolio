export default function generateResponse(query) {
  ...
  if (q.includes('教育') || q.includes('学校'))
    return 'TiceeZz 拥有<b>东华大学</b>艺术设计硕士学位（GPA 1/121）。本科就读于<b>四川农业大学</b>。';
  ...
  if (q.includes('奖') || q.includes('荣誉'))
    return '获奖包括：🏆 华灿奖 华东二等奖 | 🏆 米兰设计周 全国三等奖 | 🏆 NCDA 全国二等奖';
  if (q.includes('汉斯格雅'))
  ...
  if (q.includes('联系') || q.includes('电话'))
    return '邮箱: 1027208320@qq.com<br>电话: +86 199 7467 7449<br>坐标: 上海 长宁区';
